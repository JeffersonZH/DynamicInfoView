...
typedef CGFloat (^MLTableAlertCellHeightBlock)(MLTableAlert *alert, NSIndexPath *indexPath);
...
-(id)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelBtnTitle numberOfRows:(MLTableAlertNumberOfRowsBlock)rowsBlock andCells:(MLTableAlertTableCellsBlock)cellsBlock andCellHeight:(MLTableAlertCellHeightBlock)cellHeightBlock;
