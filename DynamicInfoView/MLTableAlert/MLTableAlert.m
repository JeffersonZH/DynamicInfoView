...
@property (nonatomic, strong) MLTableAlertCellHeightBlock cellHeight;
...
+(MLTableAlert *)tableAlertWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelBtnTitle numberOfRows:(MLTableAlertNumberOfRowsBlock)rowsBlock andCells:(MLTableAlertTableCellsBlock)cellsBlock andCellHeight:(MLTableAlertCellHeightBlock)cellHeightBlock
{
	return [[self alloc] initWithTitle:title cancelButtonTitle:cancelBtnTitle numberOfRows:rowsBlock andCells:cellsBlock andCellHeight:cellHeightBlock];
}

#pragma mark - MLTableAlert Initialization

-(id)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle numberOfRows:(MLTableAlertNumberOfRowsBlock)rowsBlock andCells:(MLTableAlertTableCellsBlock)cellsBlock andCellHeight:(MLTableAlertCellHeightBlock)cellHeightBlock
{
	// Thr ow exception if rowsBlock or cellsBlock is nil
...
-(void)show
{
	...
	UIImageView *alertBgImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"TableAlertBackground.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:30]];
	...
	UIImageView *maskShadow = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"TableAlertShadowMask.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:7]];
	...
	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"TableAlertButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"TableAlertButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
...
{
    return self.cellHeight(self, indexPath);
}
